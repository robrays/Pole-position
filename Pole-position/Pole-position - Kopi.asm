...
//
	...
	*/
	.org URXCaddr		
		RJMP URXC_INT_HANDELER	; Husk Yonas kalder denne for RX_INT

	/* 
		Interupt vector address for INT0 - Accelerometer 
	*/
	.org INT0addr	 
		RJMP INT0_INT_HANDELER	; Husk Yonas kalder denen for INT0_INT

	/* 
		Interupt vector address for INT0 - Opto sensor 1 and 2 
	*/
	.org INT1addr	 
		RJMP INT1_INT_HANDELER	; Husk Yonas kalder denne for INT1_INT

	/* 
		Interupt vector address for INT0 - Hall sensor 
	*/
	.org INT2addr	 
		RJMP INT2_INT_HANDELER	; Husk Yonas kalder denne for INT2_INT
		
	/*
		Timer 1 Output Compare Match A
	*/
	.org OC1Aaddr
		JMP OC1A_INTERRUPT_HANDLER	; Husk Yonas kalder denne for OCF1A_INT				
